        ...
        <div className='mt-10 flex flex-col-reverse md:flex-row justify-between'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField handleChange={handleChange} address={address} name='phoneNumber' type='text' placeholder='Phone Number' />

                    <button className='w-full px-4 py-3 mt-6 text-sm font-semibold text-white bg-primary hover:bg-primary-dull rounded-md transition cursor-pointer uppercase'>Save address</button>
                </form>
            </div>
